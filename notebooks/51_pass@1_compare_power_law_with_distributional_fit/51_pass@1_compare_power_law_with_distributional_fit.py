...
llmonkeys_joint_power_law_and_distr_fit_df = pd.merge(
    ...
    llmonkeys_lst_sqrs_fitted_power_law_parameters_df[["Model", "Power Law Exponent"]],
    on=["Model"],
    how="inner",
...
bon_jailbreaking_joint_power_law_and_distr_fit_df = pd.merge(
    bon_jailbreaking_beta_binomial_mle_df[["Model", "Power Law Exponent"]],
    bon_jailbreaking_lst_sqrs_fitted_power_law_parameters_df[
        ["Model", "Power Law Exponent"]
    ],
    on=["Model"],
    how="inner",
    suffixes=("_BetaBinom", "_LstSqrs"),
